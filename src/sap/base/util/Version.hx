...
@:native("module:sap/base/util/Version")
...
extern class Version
{
	...
	* @return	Object
	*/
	public function new( ?vMajor:sap.base.util.Version, ?iMinor:Int, ?iPatch:Int, ?sSuffix:String):Void;
...
The version with which this version should be compared can be given as a <code>sap/base/util/Version</code> instance, as a string (e.g. <code>v.compareto("1.4.5")</code>). Or major, minor, patch and suffix values can be given as separate parameters (e.g. <code>v.compareTo(1, 4, 5)</code>) or in an array (e.g. <code>v.compareTo([1, 4, 5])</code>).
	...
	*/
	...
	@:overload( function(vMin:String, vMax:sap.base.util.Version):Bool{ })
	@:overload( function(vMin:Array<Dynamic>, vMax:String):Bool{ })
	@:overload( function(vMin:Array<Dynamic>, vMax:Array<Dynamic>):Bool{ })
	@:overload( function(vMin:Array<Dynamic>, vMax:sap.base.util.Version):Bool{ })
	@:overload( function(vMin:sap.base.util.Version, vMax:String):Bool{ })
	@:overload( function(vMin:sap.base.util.Version, vMax:Array<Dynamic>):Bool{ })
...
The boundaries against which this version should be checked can be given as <code>sap/base/util/Version</code> instances (e.g. <code>v.inRange(v1, v2)</code>), as strings (e.g. <code>v.inRange("1.4", "2.7")</code>) or as arrays (e.g. <code>v.inRange([1,4], [2,7])</code>).
	...
	*/
	public function inRange( vMin:sap.base.util.Version, vMax:sap.base.util.Version):Bool;
