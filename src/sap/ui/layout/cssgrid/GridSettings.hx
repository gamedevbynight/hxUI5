...
@:native("sap.ui.layout.cssgrid.GridSettings")

/**
* Holds a set of CSS display:grid properties
*/
extern class GridSettings extends sap.ui.base.ManagedObject
{
	@:overload(function(?sId:String, ?mSettings:GridSettingsArgs):Void {})
	public function new(?mSettings:GridSettingsArgs):Void;
