...
Event is fired when the user navigates to another page by selecting it directly, or by jumping forward/backward.
	...
	*/
	public function attachPage( ?oData:Dynamic, fnFunction:(Dynamic)->Void, ?oListener:Dynamic):sap.ui.commons.Paginator;
...
The passed function and listener object must match the ones used for event registration.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function detachPage( fnFunction:(Dynamic)->Void, ?oListener:Dynamic):sap.ui.commons.Paginator;
