...
*/
extern class Callout extends sap.ui.commons.CalloutBase
{
	@:overload(function(?sId:String, ?mSettings:CalloutArgs):Void {})
	public function new(?mSettings:CalloutArgs):Void;
	...
	*/
	public function addContent( oContent:sap.ui.core.Control):sap.ui.commons.Callout;

	/**
	* Destroys all the content in the aggregation {@link #getContent content}.
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function destroyContent( ):sap.ui.commons.Callout;
...
Determines the content of the Callout
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function insertContent( oContent:sap.ui.core.Control, iIndex:Int):sap.ui.commons.Callout;
...
typedef CalloutArgs = sap.ui.commons.CalloutBase.CalloutBaseArgs & {
