...
@:native("sap.ui.model.odata.type.Single")
...
*/
extern class Single extends sap.ui.model.odata.type.ODataType
{
...
<code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.model.odata.type.ODataType.extend}.
	...
	* @param	vValue the value to be parsed; the empty string and <code>null</code> are parsed to <code>null</code>; note that there is no way to enter <code>Infinity</code> or <code>NaN</code> values
	...
	* @return	Void
	*/
	public function validateValue( fValue:String):Void;
}
