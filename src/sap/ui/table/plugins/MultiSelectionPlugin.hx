...
This event is fired when the selection is changed.
	...
	*/
	public function attachSelectionChange( ?oData:Dynamic, fnFunction:(Dynamic)->Void, ?oListener:Dynamic):sap.ui.table.plugins.MultiSelectionPlugin;
...
The passed function and listener object must match the ones used for event registration.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function detachSelectionChange( fnFunction:(Dynamic)->Void, ?oListener:Dynamic):sap.ui.table.plugins.MultiSelectionPlugin;
