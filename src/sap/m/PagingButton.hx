...
Fired when the current position is changed.
	...
	*/
	public function attachPositionChange( ?oData:Dynamic, fnFunction:()->Void, ?oListener:Dynamic):sap.m.PagingButton;
...
The passed function and listener object must match the ones used for event registration.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function detachPositionChange( fnFunction:()->Void, ?oListener:Dynamic):sap.m.PagingButton;
