...
See {@link sap.m.Button#event:press}
	...
	*/
	public function attachPress( ?oData:Dynamic, fnFunction:(Dynamic)->Void, ?oListener:Dynamic):sap.m.semantic.SemanticButton;
...
The passed function and listener object must match the ones used for event registration.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function detachPress( fnFunction:(Dynamic)->Void, ?oListener:Dynamic):sap.m.semantic.SemanticButton;
