...
By default, this is set to <code>false</code>, so the src image is loaded directly without attempting to fetch the density perfect image for high-density devices.
