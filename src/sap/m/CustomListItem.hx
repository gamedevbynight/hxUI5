...
*/
extern class CustomListItem extends sap.m.ListItemBase
{
	@:overload(function(?sId:String, ?mSettings:CustomListItemArgs):Void {})
	public function new(?mSettings:CustomListItemArgs):Void;
	...
	*/
	public function addContent( oContent:sap.ui.core.Control):sap.m.CustomListItem;
...
See {@link sap.ui.base.ManagedObject#bindAggregation ManagedObject.bindAggregation} for a detailed description of the possible properties of <code>oBindingInfo</code>.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function bindContent( oBindingInfo:Dynamic):sap.m.CustomListItem;

	/**
	* Destroys all the content in the aggregation {@link #getContent content}.
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function destroyContent( ):sap.m.CustomListItem;
...
The content of this list item
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function insertContent( oContent:sap.ui.core.Control, iIndex:Int):sap.m.CustomListItem;
...
Additionally, it unregisters them from the hosting UIArea.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function unbindContent( ):sap.m.CustomListItem;
}

typedef CustomListItemArgs = sap.m.ListItemBase.ListItemBaseArgs & {
