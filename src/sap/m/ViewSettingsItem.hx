...
Let the outside world know that some of its properties has changed.
	...
	*/
	public function attachItemPropertyChanged( ?oData:Dynamic, fnFunction:(Dynamic)->Void, ?oListener:Dynamic):sap.m.ViewSettingsItem;
...
The passed function and listener object must match the ones used for event registration.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function detachItemPropertyChanged( fnFunction:(Dynamic)->Void, ?oListener:Dynamic):sap.m.ViewSettingsItem;
