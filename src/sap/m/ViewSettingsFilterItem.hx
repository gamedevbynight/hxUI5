...
Let the outside world know that the filter detail aggregation was changed.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function attachFilterDetailItemsAggregationChange( ?oData:Dynamic, fnFunction:()->Void, ?oListener:Dynamic):sap.m.ViewSettingsFilterItem;
...
The passed function and listener object must match the ones used for event registration.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function detachFilterDetailItemsAggregationChange( fnFunction:()->Void, ?oListener:Dynamic):sap.m.ViewSettingsFilterItem;
