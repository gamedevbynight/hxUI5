...
Fired when an item is selected.
	...
	*/
	public function attachItemSelect( ?oData:Dynamic, fnFunction:()->Void, ?oListener:Dynamic):sap.tnt.SideNavigation;
...
The passed function and listener object must match the ones used for event registration.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function detachItemSelect( fnFunction:()->Void, ?oListener:Dynamic):sap.tnt.SideNavigation;
