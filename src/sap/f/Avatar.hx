...
extern class Avatar extends sap.ui.core.Control
{
	...
	@:overload( function(vAriaDescribedBy:sap.ui.core.ID):sap.f.Avatar{ })
	...
	*/
	public function addAriaDescribedBy( vAriaDescribedBy:sap.ui.core.Control):sap.f.Avatar;
	@:overload( function(vAriaLabelledBy:sap.ui.core.ID):sap.f.Avatar{ })
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function addAriaLabelledBy( vAriaLabelledBy:sap.ui.core.Control):sap.f.Avatar;
...
Fired when the user selects the control.
	...
	* @param	oListener Context object to call the event handler with. Defaults to this <code>sap.f.Avatar</code> itself
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function attachPress( ?oData:Dynamic, fnFunction:()->Void, ?oListener:Dynamic):sap.f.Avatar;
...
See {@link sap.ui.base.ManagedObject#bindAggregation ManagedObject.bindAggregation} for a detailed description of the possible properties of <code>oBindingInfo</code>.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function bindDetailBox( oBindingInfo:Dynamic):sap.f.Avatar;

	/**
	* Destroys the detailBox in the aggregation {@link #getDetailBox detailBox}.
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function destroyDetailBox( ):sap.f.Avatar;
...
The passed function and listener object must match the ones used for event registration.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function detachPress( fnFunction:()->Void, ?oListener:Dynamic):sap.f.Avatar;
...
Default value is <code>Circle</code>.
	...
	*/
	public function getDisplayShape( ):sap.f.AvatarShape;
...
Default value is <code>S</code>.
	...
	*/
	public function getDisplaySize( ):sap.f.AvatarSize;
...
Default value is <code>Cover</code>.
	...
	*/
	public function getImageFitType( ):sap.f.AvatarImageFitType;
...
Default value is <code>3rem</code>.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function setCustomDisplaySize( sCustomDisplaySize:sap.ui.core.CSSSize):sap.f.Avatar;
...
Default value is <code>1.125rem</code>.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function setCustomFontSize( sCustomFontSize:sap.ui.core.CSSSize):sap.f.Avatar;
...
Default value is <code>Circle</code>.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function setDisplayShape( sDisplayShape:sap.f.AvatarShape):sap.f.Avatar;
...
Default value is <code>S</code>.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function setDisplaySize( sDisplaySize:sap.f.AvatarSize):sap.f.Avatar;
...
When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function setFallbackIcon( sFallbackIcon:String):sap.f.Avatar;
...
Default value is <code>Cover</code>.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function setImageFitType( sImageFitType:sap.f.AvatarImageFitType):sap.f.Avatar;
...
When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
	...
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function setSrc( sSrc:sap.ui.core.URI):sap.f.Avatar;

	/**
	* Unbinds aggregation {@link #getDetailBox detailBox} from model data.
	* @return	Reference to <code>this</code> in order to allow method chaining
	*/
	public function unbindDetailBox( ):sap.f.Avatar;
}
...
typedef AvatarArgs = sap.ui.core.Control.ControlArgs & {
	...
	* Defines the shape of the <code>Avatar</code>.
	*/
	@:optional var displayShape:haxe.extern.EitherType<String,sap.f.AvatarShape>;

	/**
	* Sets a predefined display size of the <code>Avatar</code>.
	*/
	@:optional var displaySize:haxe.extern.EitherType<String,sap.f.AvatarSize>;
...
<b>Note:</b> It takes effect if the <code>displaySize</code> property is set to <code>Custom</code>.
	...
	* Specifies how an image would fit in the <code>Avatar</code>.
	*/
	@:optional var imageFitType:haxe.extern.EitherType<String,sap.f.AvatarImageFitType>;
