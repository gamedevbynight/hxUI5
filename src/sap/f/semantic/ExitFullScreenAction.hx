...
@:native("sap.f.semantic.ExitFullScreenAction")
...
*/
extern class ExitFullScreenAction extends sap.f.semantic.SemanticButton
{
	@:overload(function(?sId:String, ?mSettings:ExitFullScreenActionArgs):Void {})
	public function new(?mSettings:ExitFullScreenActionArgs):Void;
...
typedef ExitFullScreenActionArgs = sap.f.semantic.SemanticButton.SemanticButtonArgs & {
}
