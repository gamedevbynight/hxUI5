...
@:native("sap.f.semantic.FavoriteAction")
...
*/
extern class FavoriteAction extends sap.f.semantic.SemanticToggleButton
{
...
typedef FavoriteActionArgs = sap.f.semantic.SemanticToggleButton.SemanticToggleButtonArgs & {
}
