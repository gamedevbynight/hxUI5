...
@:native("sap.f.semantic.FooterMainAction")
...
*/
extern class FooterMainAction extends sap.f.semantic.MainAction
{
	@:overload(function(?sId:String, ?mSettings:FooterMainActionArgs):Void {})
	public function new(?mSettings:FooterMainActionArgs):Void;
...
typedef FooterMainActionArgs = sap.f.semantic.MainAction.MainActionArgs & {
}
