...
@:native("sap.f.semantic.CopyAction")
...
*/
extern class CopyAction extends sap.f.semantic.SemanticButton
{
	@:overload(function(?sId:String, ?mSettings:CopyActionArgs):Void {})
	public function new(?mSettings:CopyActionArgs):Void;
...
typedef CopyActionArgs = sap.f.semantic.SemanticButton.SemanticButtonArgs & {
}
