...
The given object must provide method <code>onLogEntry</code> and can also be informed about <code>onDetachFromLog</code> and <code>onAttachToLog</code>
	...
	*/
	public static function debug( sMessage:String, ?sDetails:String, ?sComponent:String, ?fnSupportInfo:(Dynamic)->Void):jquery.sap.log.Logger;
	...
	* @return	The log instance
	*/
	public static function error( sMessage:String, ?sDetails:String, ?sComponent:String, ?fnSupportInfo:(Dynamic)->Void):jquery.sap.log.Logger;
	...
	*/
	public static function fatal( sMessage:String, ?sDetails:String, ?sComponent:String, ?fnSupportInfo:(Dynamic)->Void):jquery.sap.log.Logger;
...
The optional second parameter <code>iDefaultLogLevel</code> allows to specify a default log level for the component. It is only applied when no log level has been defined so far for that component (ignoring inherited log levels). If this method is called multiple times for the same component but with different log levels, only the first call one might be taken into account.
	...
	* @return	The log instance
	*/
	public static function info( sMessage:String, ?sDetails:String, ?sComponent:String, ?fnSupportInfo:(Dynamic)->Void):jquery.sap.log.Logger;
...
<b>Note</b>: Setting a global default log level has no impact on already defined component log levels. They always override the global default log level.
	...
	* @return	The log-instance
	*/
	public static function trace( sMessage:String, ?sDetails:String, ?sComponent:String, ?fnSupportInfo:(Dynamic)->Void):jquery.sap.log.Logger;
	...
	* @return	The log instance
	*/
	public static function warning( sMessage:String, ?sDetails:String, ?sComponent:String, ?fnSupportInfo:(Dynamic)->Void):jquery.sap.log.Logger;
}
